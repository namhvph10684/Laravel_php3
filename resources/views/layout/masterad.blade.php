...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-dark">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="http://127.0.0.1:8000/auth/logout" class="nav-link">Đăng Xuất</a>
      </li>
    </ul>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          ...
          @endif
          {{-- <img src="{{asset('/adminlte/dist/img/adminhvn.jpg')}}" class="img-circle elevation-2" alt="User Image"> --}}
        </div>
        <div class="info">
          <a href="#" class="d-block"><!-- Auth::check() trả về true/false đã đăng nhập hay chưa -->
            @if (Auth::check())
  ...
  <div class="">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">@yield('content-tile')</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
